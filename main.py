...
for fold_idx in range(n_fold):
    ...
    train_stage1(net, optimizer, train_loader, val_loader, fold=fold_idx)
    finetune_stage1(net, train_loader, val_loader, fold=fold_idx)
    finetune_stage2(net, train_loader, val_loader, fold=fold_idx)
